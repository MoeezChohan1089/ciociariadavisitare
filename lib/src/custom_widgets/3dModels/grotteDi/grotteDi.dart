...
class GrotteDiModelViewerPage extends StatefulWidget {
  const GrotteDiModelViewerPage({super.key});

  @override
  State<GrotteDiModelViewerPage> createState() =>
      _GrotteDiModelViewerPageState();
}

class _GrotteDiModelViewerPageState extends State<GrotteDiModelViewerPage> {
  String js = '''
(() => {
...
''';
          ...
          ? Center(
              child: Padding(
                ...
                child: ModelViewer(
                  ...
                  backgroundColor: Colors.white,
                  src: 'assets/models/GrotteDiCollepardo.glb',
                  alt: 'A 3D model of an grotte di collepardo',
                  ar: true,
  ...
  ARKitGltfNode _getNodeFromFlutterAsset(double scale) {
    ...
    ARKitGltfNode modelNode = ARKitGltfNode(
      ...
      url:
          'assets/models/GrotteDiCollepardo.glb', // Change the file name to your glb file
