      ...
      data: Theme.of(context).copyWith(
        textSelectionTheme: TextSelectionThemeData(
          selectionColor: Colors
              .transparent, // Set the color to transparent or to the color you prefer.
          selectionHandleColor:
              Colors.transparent, // Same here, set to your preference.
        ),
      ),
      child: TextFormField(
        ...
        style: context.text.bodyLarge?.copyWith(color: AppColors.appTextColor),
        ...
        decoration: InputDecoration(
          isDense: true,
          filled: true,
          fillColor: AppColors.customWhiteTextColor,
          contentPadding: EdgeInsets.symmetric(
              horizontal: 15,
              vertical: fieldVerticalPadding != null
          ...
          hintText: hint,
          hintStyle:
              context.text.bodyMedium?.copyWith(color: AppColors.appHintColor),
          ...
          errorStyle: context.text.bodySmall
              ?.copyWith(color: AppColors.appPriceRedColor, fontSize: 11.sp),
