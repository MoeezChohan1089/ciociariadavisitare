...
class MuraCiclopichoModelViewerPage extends StatefulWidget {
  const MuraCiclopichoModelViewerPage({super.key});

  @override
  State<MuraCiclopichoModelViewerPage> createState() =>
      _MuraCiclopichoModelViewerPageState();
}

class _MuraCiclopichoModelViewerPageState
    extends State<MuraCiclopichoModelViewerPage> {
  String js = '''
(() => {
          ...
          ? Center(
              child: Padding(
                ...
                child: ModelViewer(
                  ...
                  backgroundColor: Colors.white,
                  src: 'assets/models/MuraCiclopiche.glb',
                  alt: 'A 3D model of an mura ci clopiche',
                  ar: true,
